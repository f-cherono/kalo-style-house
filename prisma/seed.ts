...
const products = [
  ...
  {
    slug: "marshmallow-blush-fragrance-mist",
    name: "Marshmallow Blush Fragrance Mist",
    description:
      "A sweet, playful fragrance mist with soft marshmallow and blush floral notes. Travel-friendly 15ml size, perfect for topping up on the go.",
    price: 220000,
    category: "Perfumes",
    image: "/products/marshmallow-blush-fragrance-mist.jpg",
    images: JSON.stringify(["/products/marshmallow-blush-fragrance-mist.jpg"]),
    sizes: JSON.stringify(["15ml"]),
    stock: 75,
    featured: false,
  },
  {
  ...
  {
    slug: "premium-curly-wig-with-tendrils",
    name: "Premium Curly Wig with Tendrils",
    description:
      "A romantic curly wig with soft face-framing tendrils and a natural lace parting. Full coverage with a lightweight, breathable cap.",
    price: 1350000,
    category: "Wigs & Hair Extensions",
    image: "/products/premium-curly-wig-with-tendrils.jpg",
    images: JSON.stringify(["/products/premium-curly-wig-with-tendrils.jpg"]),
    sizes: JSON.stringify(["16in", "18in", "20in"]),
    stock: 30,
    featured: false,
  },

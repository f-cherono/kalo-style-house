...
const products = [
  ...
  // Perfumes
  {
    ...
    description:
      "A rich, long-lasting fragrance blending warm amber, smoky oud, and a hint of vanilla. Unisex and perfect for everyday wear or special occasions.",
    price: 580000,
    category: "Perfumes",
    image: "https://images.unsplash.com/photo-1543422655-ac1c6ca993ed?w=1200&q=80",
    images: JSON.stringify([
      "https://images.unsplash.com/photo-1543422655-ac1c6ca993ed?w=1200&q=80",
    ]),
  ...
  {
    slug: "rose-musk-fragrance-oil",
    name: "Rose Musk Fragrance Oil",
    description:
      "An alcohol-free oil-based fragrance layering soft rose petals with creamy white musk. Long-wearing and skin-friendly.",
    price: 420000,
    category: "Perfumes",
    image: "https://images.unsplash.com/photo-1505239034653-abfc95288b6c?w=1200&q=80",
    images: JSON.stringify([
      "https://images.unsplash.com/photo-1505239034653-abfc95288b6c?w=1200&q=80",
    ]),
    sizes: JSON.stringify(["12ml", "30ml"]),
    stock: 100,
    featured: true,
  },
  {
  ...
  {
    slug: "luxe-human-hair-lace-front-wig",
    name: "Luxe Human Hair Lace Front Wig",
    description:
      "100% virgin human hair lace front wig with a natural hairline and pre-plucked baby hairs. Soft, silky, and ready to wear or customize.",
    price: 2050000,
    category: "Wigs & Hair Extensions",
    image: "https://images.unsplash.com/photo-1634315775834-3e1ac73de6b6?w=1200&q=80",
    images: JSON.stringify([
      "https://images.unsplash.com/photo-1634315775834-3e1ac73de6b6?w=1200&q=80",
    ]),
  ...
  {
    slug: "silky-straight-clip-in-extensions",
    name: "Silky Straight Clip-In Extensions",
    description:
      "Double-wefted clip-in extensions for instant length and volume. Heat-friendly and blends seamlessly with natural hair.",
    price: 1150000,
    category: "Wigs & Hair Extensions",
    image: "https://images.unsplash.com/photo-1535911974356-3748cdc9d2f5?w=1200&q=80",
    images: JSON.stringify([
      "https://images.unsplash.com/photo-1535911974356-3748cdc9d2f5?w=1200&q=80",
    ]),
    sizes: JSON.stringify(["16in", "18in", "20in", "24in"]),
    stock: 50,
    featured: true,
  },
  {
    slug: "curly-bundle-hair-extensions",
    name: "Curly Bundle Hair Extensions",
    description:
      "Deep curly bundles that hold their pattern wash after wash. Sold as sew-in wefts for a full, natural-looking install.",
    price: 1280000,
    category: "Wigs & Hair Extensions",
    image: "https://images.unsplash.com/photo-1535911974356-3748cdc9d2f5?w=1200&q=80&sat=-15",
    images: JSON.stringify([
      "https://images.unsplash.com/photo-1535911974356-3748cdc9d2f5?w=1200&q=80&sat=-15",
    ]),
